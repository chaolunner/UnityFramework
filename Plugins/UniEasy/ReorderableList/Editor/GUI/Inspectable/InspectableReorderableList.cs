...
namespace UniEasy.Editor
{
    ...
    // TODO: make it not rely on GUILayout at all, so its safe to use under InspectableDrawers.
    public class InspectableReorderableList
    {
        ...
        public delegate void ReorderCallbackDelegateWithDetails(InspectableReorderableList list, int oldIndex, int newIndex);

        public delegate void ReorderCallbackDelegate(InspectableReorderableList list);

        public delegate void SelectCallbackDelegate(InspectableReorderableList list);

        public delegate void AddCallbackDelegate(InspectableReorderableList list);

        public delegate void AddDropdownCallbackDelegate(Rect buttonRect, InspectableReorderableList list);

        public delegate void RemoveCallbackDelegate(InspectableReorderableList list);

        public delegate void ChangedCallbackDelegate(InspectableReorderableList list);

        public delegate bool CanRemoveCallbackDelegate(InspectableReorderableList list);

        public delegate bool CanAddCallbackDelegate(InspectableReorderableList list);
        ...
        private GUISlideGroupHelper m_SlideGroup;

        private SerializedObject m_SerializedObject;
        private InspectableProperty m_Elements;
        ...
        public class Defaults
        {
            ...
            private static GUIContent s_ListIsEmpty = new GUIContent("List is Empty");
            ...
            public void DrawHeader(Rect headerRect, SerializedObject serializedObject, InspectableProperty element, IList elementList)
            {
                EditorGUI.LabelField(headerRect, EditorGUIUtilityHelper.TempContent((element != null) ? "Inspectable Property" : "IList"));
            }
            ...
            public void DrawElement(Rect rect, InspectableProperty element, System.Object listItem, bool selected, bool focused, bool draggable)
            {
        ...
        // constructors
        public InspectableReorderableList(IList elements, Type elementType)
        {
            InitList(null, null, elements, true, true, true, true);
        }

        public InspectableReorderableList(IList elements, Type elementType, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            InitList(null, null, elements, draggable, displayHeader, displayAddButton, displayRemoveButton);
        }

        public InspectableReorderableList(SerializedObject serializedObject, InspectableProperty elements)
        {
            InitList(serializedObject, elements, null, true, true, true, true);
        }

        public InspectableReorderableList(SerializedObject serializedObject, InspectableProperty elements, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            InitList(serializedObject, elements, null, draggable, displayHeader, displayAddButton, displayRemoveButton);
        }

        private void InitList(SerializedObject serializedObject, InspectableProperty elements, IList elementList, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            id = GUIUtilityHelper.GetPermanentControlID();
            m_SerializedObject = serializedObject;
            m_Elements = elements;
            m_ElementList = elementList;
            m_Draggable = draggable;
            m_Dragging = false;
            m_SlideGroup = new GUISlideGroupHelper();
            ...
            if (m_Elements != null && m_Elements.IsArray == false)
                Debug.LogError("Input elements should be an Array InspectableProperty");
        }

        public InspectableProperty inspectableProperty
        {
                ...
                case EventType.MouseUp:
                    ...
                    try
                    {
                        ...
                        if (m_ActiveElement != targetIndex)
                        {
                            ...
                            {
                                // if we are working with Inspectable Properties, we can handle it for you
