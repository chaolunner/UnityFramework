...
{
    public class RuntimeReorderableList
    {
        ...
        public delegate void ReorderCallbackDelegateWithDetails(RuntimeReorderableList list, int oldIndex, int newIndex);

        public delegate void ReorderCallbackDelegate(RuntimeReorderableList list);

        public delegate void SelectCallbackDelegate(RuntimeReorderableList list);

        public delegate void AddCallbackDelegate(RuntimeReorderableList list);

        public delegate void AddDropdownCallbackDelegate(Rect buttonRect, RuntimeReorderableList list);

        public delegate void RemoveCallbackDelegate(RuntimeReorderableList list);

        public delegate void ChangedCallbackDelegate(RuntimeReorderableList list);

        public delegate bool CanRemoveCallbackDelegate(RuntimeReorderableList list);

        public delegate bool CanAddCallbackDelegate(RuntimeReorderableList list);
        ...
        private RuntimeSerializedProperty m_Elements;
        ...
        public class Defaults
        {
            ...
            public void DrawFooter(Rect rect, RuntimeReorderableList list)
            {
            ...
            public void DoAddButton(RuntimeReorderableList list)
            {
                if (list.RuntimeSerializedProperty != null)
                {
                    list.RuntimeSerializedProperty.ArraySize += 1;
                    list.index = list.RuntimeSerializedProperty.ArraySize - 1;
                }
                else
                {
            ...
            public void DoRemoveButton(RuntimeReorderableList list)
            {
                if (list.RuntimeSerializedProperty != null)
                {
                    list.RuntimeSerializedProperty.DeleteArrayElementAtIndex(list.index);
                    if (list.index >= list.RuntimeSerializedProperty.ArraySize - 1)
                        list.index = list.RuntimeSerializedProperty.ArraySize - 1;
                }
                else
                {
        ...
        // constructors
        public RuntimeReorderableList(IList elements, Type elementType)
        {
            InitList(null, null, elements, true, true, true, true);
        }

        public RuntimeReorderableList(IList elements, Type elementType, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            InitList(null, null, elements, draggable, displayHeader, displayAddButton, displayRemoveButton);
        }

        public RuntimeReorderableList(SerializedObject serializedObject, RuntimeSerializedProperty elements)
        {
            InitList(serializedObject, elements, null, true, true, true, true);
        }

        public RuntimeReorderableList(SerializedObject serializedObject, RuntimeSerializedProperty elements, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            InitList(serializedObject, elements, null, draggable, displayHeader, displayAddButton, displayRemoveButton);
        }

        private void InitList(SerializedObject serializedObject, RuntimeSerializedProperty elements, IList elementList, bool draggable, bool displayHeader, bool displayAddButton, bool displayRemoveButton)
        {
            ...
            if (m_Elements != null && m_Elements.IsArray == false)
                Debug.LogError("Input elements should be an Array RuntimeSerializedProperty");
        }

        public RuntimeSerializedProperty RuntimeSerializedProperty
        {
